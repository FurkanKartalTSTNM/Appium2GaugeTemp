...
public class TestiniumEnvironment {
    ...
    public static void init() {
        ...
        isSigned = configReader.getPropertyValue("isSigned");
    ...
    public static Boolean isAllowedToTakeRecordVideo() {
        return Constants.DEFAULT_VIDEO_ENABLED.equalsIgnoreCase(takeScreenRecording);
    }
}
