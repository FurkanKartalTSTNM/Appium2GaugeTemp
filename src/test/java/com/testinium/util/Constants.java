...
public class Constants {
   ...
   public interface CapabilityConstants {
        ...
        String WDA_CONNECTION_TIMEOUT = "appium:wdaConnectionTimeout";
        String APPIUM_APP = "appium:app";
        String USE_PREBUILD_WDA = "appium:usePrebuiltWDA";
        String DERIVED_DATA_PATH = "derivedDataPath";
        String RESIGN_APP = "resignApp";
